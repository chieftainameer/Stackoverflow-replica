...
<form method="post" action="post_question.php" id="question-form">
	<div class="from-group" id="form-group">
		...
		<input type="text" name="title" id="title" placeholder="e.g is there any function to find the index of element in a php array" class="form-control">
	</div>
	<div class="from-group" id="form-group">
		<label><b>Description</b></label>
		<p id="tit-info"><span>include all the information someone need to answer your question</span></p>
		<textarea name="description" id="description" placeholder="Details of your expected and actual results" rows="8" cols="40" class="form-control"></textarea>
	</div>
	<div class="from-group" id="form-group">
		<label><b>Tags</b></label>
		<p id="tit-info"><span>add upto 5 tags to describe what your question is about</span></p>
		<input type="text" name="tags" id="tags" class="form-control" placeholder="e.g (php,css,html,java,android etc)">
	</div>
	<div class="from-group" id="form-group">
		<button class="btn btn-primary" id="submit-btn">Post Question</button>
	</div>
</form>
</div>
<div class="col-md-4">
